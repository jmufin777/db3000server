 cislozakazky           | biginteger                  | not null default 0 --metodika honza  RR NNN ZZZZZ  - jedno cislo ?  priklad: 1900500001 ? - preklad 2019HonzaCislo , 
 vl_rozsah              | text                        |  -- zajisti prokliky ? ,  zobrazit jako tlacitka kvuli oddeleni? zobrazeni VL - formular bez editace, protoze VL prochazi rakdami kalkulace dle technologie, vzhledem ke slozitost dedukce VL 
                                                         -- bude nutne zajstit aktualizaci sem a prikazde zmene polozku aktualizovat 
 ...
 cisloobjednavky        | character varying(255)      | -- textove - zadat pokud bude k dispozici, v navrzenem formulari chybi , kamumistit ? obsahuje napr, text Pawlasova...
 datumzadani            | timestamp without time zone |  -- automat, system
 datumexpedice          | timestamp without time zone |  not null -- musi byt vyplneno pri zadani (budem kalkulavat)  
 ...
 poznamky               | text                        | -- Pouzva se texty napr.  50% zálohovka - Zálohová faktura č. 190800018 , kam s tim na obrazovce ?
 ...
 uct_rok                | integer                     | -- rusime - je na pevno dano expedici ?
 ...
 cislofaktury           | character varying(50)       | -- ponechamme,pouziva se  lec - kam umistime na obrazovce ? 190102117 
