#!/bin/bash 
 sudo /usr/bin/convert  "/var/www/db3000/server/uploads/ultimate wheels fall 2019.pdf[0]" -thumbnail 800x600 "/home/db3000/db/thumbs/ULT/1912300158/ultimate wheels fall 2019_800.jpg"
